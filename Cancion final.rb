...
live_loop :bombo do
  sync :tick
  if get(:bombo) == 1  # Solo suena si la variable está en 1
...
live_loop :controlador do
  #sync :tick
  # Aquí cambias el estado de cada loop (0 = apagado, 1 = encendido)
  set :bombo, 0
  set :hihat, 0
  set :snare_hihat, 0
  set :toms, 0
